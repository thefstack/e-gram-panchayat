...
function AdminDashboard() {
  ...
  return (
    <Wrapper>
        <Link to="/admin" style={{color:"#000", textDecoration:"none"}}><h1>Admin Dashboard</h1></Link>
      ...
      <Sidebar isOpen={isSidebarOpen}>
        ...
        <Link to="/admin/create-service"> <Button>Create Service</Button></Link>
        <Link to="/admin/"><Button>Manage Services</Button></Link>
        <Link to="/admin/application/update/:applicationId"><Button>Update Application Status</Button></Link>
        <Link to="/admin/create-staff"><Button>Create Staff Account</Button></Link>

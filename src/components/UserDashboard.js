...
function UserDashboard() {
  ...
  return (
    <Wrapper>
        <Link to="/user" style={{color:"#000", textDecoration:"none"}}><h1>Welcome User</h1></Link>
      ...
      <Sidebar isOpen={isSidebarOpen}>
        ...
        <Link to="/user"> <Button>Search Service</Button></Link>
        <Link to="/user/applications"><Button>Application Status</Button></Link>
        <Link to="/user/:userId"><Button>My Profile</Button></Link>
